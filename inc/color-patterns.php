 ...
 */
function dvseventeen_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter DV Seventeen default saturation level.
	 *
	 * @since DV Seventeen 1.0
	 *
	 * @param $saturation integer
	 */
	$saturation = absint( apply_filters( 'dvseventeen_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.dvseventeen-front-page) .entry-title,
...
.colors-custom .dvseventeen-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.dvseventeen-front-page .panel-content .recent-posts article,
...
.colors-custom.dvseventeen-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters DV Seventeen custom colors CSS.
	 *
	 * @since DV Seventeen 1.0
	 *
	 ...
	 */
	return apply_filters( 'dvseventeen_custom_colors_css', $css, $hue, $saturation );
}
